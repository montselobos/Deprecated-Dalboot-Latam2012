...
function bootstrapwp_widgets_init() {
  ...
  register_sidebar(array(
    ...
    'before_widget' => '<div class="widget left-box">
    ...
    'before_widget' => '<div class="widget center-box">
          <div class="box-top"></div>
            <div class="box-contentwrap"> ',
    'after_widget'  => '</div></div>',
    'before_title'  => '<h2>',
    ...
    'before_widget' => '<div class="widget right-box ">
          <div class="box-top"></div>
            <div class="box-contentwrap"> ',
    'after_widget'  => '</div></div>',
    'before_title'  => '<h2>',
  ...
  //CUSTOM DAL DINAMIC SIDEBARS
    ...
    'before_widget' => '<div id="%1$s" class="widget widslogan %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<h2>',
    'after_title'   => '</h2>'
  ));
    ...
    'name' => 'DAL Ideas',
    'id'   => 'ideas',
    'description'   => 'Sidebar de página Ideas',
    'before_widget' => '<div id="%1$s" class="widget %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<h2>',
    'after_title'   => '</h2>'
